          ...
          @foreach($applications as $application )
              @if(($application->status_id) == 2)
                <tr>
                  ...
                  <td>{{ $application->company }}</td>
                  <td>
                      <a href="{{ route('applications.offer.received', [$application->course_application_id]) }}" title="offer_received" class="btn"><i class="glyphicon glyphicon-education"></i> Offer received</a>
